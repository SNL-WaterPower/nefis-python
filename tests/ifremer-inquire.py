...
def test_nefis_inquire():
    ...
    dat_file = 'trim-T6.dat'
    def_file = 'trim-T6.def'
    coding = ' '
    ac_type = 'r'
    fp = -1
    print('------------')
...
#    print('---inqelm---')
#    elm_name = 'Element 1'
#    elm_dimensions = np.arange(5,dtype=np.int32).reshape(5)
#    elm_dimensions[0] = 0
#    elm_dimensions[1] = 0
#    elm_dimensions[2] = 0
#    elm_dimensions[3] = 0
...
#        print('Dimensions : "%s"' % elm_dimensions)
    ...
    error, grp_defined, cel_name, grp_dim_count, grp_dimensions, grp_order = nefis.inqfgr(fp)
    if not error == 0:
        error, err_string = nefis.neferr()
        print('    NEFIS error string       : "%s"' % err_string)
        print('    =========')
    ...
    while True :
      ...
      error, grp_defined, cel_name, grp_dim_count, grp_dimensions, grp_order = nefis.inqngr(fp)
      if not error == 0:
          error, err_string = nefis.neferr()
          print('    NEFIS error string       : "%s"' % err_string)
          print('    =========')
    ...
    #-------------------------------------------------------------------------------
    print('---inqgrp---')
    grp_defined = 'map-series'

    error, cel_name, grp_count, grp_dimensions, grp_order = nefis.inqgrp(fp, grp_defined)
    if not error == 0:
        error, err_string = nefis.neferr()
        print('    NEFIS error string       : "%s"' % err_string)
        print('    =========')
    ...
    print('---inqfcl---')
    count = 2
    error, cel_name, count, bytes, elm_names = nefis.inqfcl(fp)
    if not error == 0:
        error, err_string = nefis.neferr()
        print('    NEFIS error string       : "%s"' % err_string)
        print('    =========')
        ...
        for i in range(count):
            print('Name %d: "%s"' % ( i, elm_names[17*i:17*(i+1)]) )
    #-------------------------------------------------------------------------------
    while True :
      print('---inqncl---')
      count = 2
      error, cel_name, count, bytes, elm_names = nefis.inqncl(fp)
      if not error == 0:
          error, err_string = nefis.neferr()
          print('    NEFIS error string       : "%s"' % err_string)
          print('    =========')
    ...
    #-------------------------------------------------------------------------------
    print('---inqfel---')
    error, elm_name, elm_type, elm_quantity, elm_unit, elm_description, elm_single_byte, elm_size, elm_count, elm_dimensions = nefis.inqfel(fp)
    if not error == 0:
        error, err_string = nefis.neferr()
        print('    NEFIS error string       : "%s"' % err_string)
        print('    =========')
    ...
    #while False :
      print('---inqnel---')
      error, elm_name, elm_type, elm_quantity, elm_unit, elm_description, elm_single_byte, elm_size, elm_count, elm_dimensions = nefis.inqnel(fp)
      if not error == 0:
          error, err_string = nefis.neferr()
          print('    NEFIS error string       : "%s"' % err_string)
          print('    =========')
