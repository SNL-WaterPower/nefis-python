...
def test_nefis_putelt_integers():
    ...
    elm_dimensions = np.arange(elm_count,dtype=np.int32).reshape(elm_count)
    elm_dimensions[0] = 20
    elm_dimensions[1] = 5
    ...
    cel_name = 'Cell 1'
    grp_count = 1
    grp_dimensions = np.arange(5,dtype=np.int32).reshape(5)
    grp_dimensions[0] = 11
    grp_dimensions[1] = 0
    grp_dimensions[2] = 0
    grp_dimensions[3] = 0
    grp_dimensions[4] = 0
    grp_order = np.arange(5,dtype=np.int32).reshape(5)
    grp_order[0] = 1
    grp_order[1] = 2
    grp_order[2] = 3
    grp_order[3] = 4
    ...
    #-------------------------------------------------------------------------------
    print('---putelt---')
    usr_index = np.arange(15,dtype=np.int32).reshape(5,3)
    usr_index[0,0] = 11
    usr_index[0,1] = 11
    usr_index[0,2] = 1
    usr_index[1,0] = 0
