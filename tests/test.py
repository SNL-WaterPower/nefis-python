...
cel_name = 'Cell 1'
count = 2
error, count, elm_names = nefis.inqcel(fp, cel_name)
if not error == 0:
    error, err_string = nefis.neferr()
    print('    NEFIS error string       : "%s"' % err_string)
    print('    =========')
...
error, grp_defined, cel_name, grp_count_dimensions, grp_dimensions, grp_order = nefis.inqfgr(fp)
if not error == 0:
    error, err_string = nefis.neferr()
    print('    NEFIS error string       : "%s"' % err_string)
    print('    =========')
...
error, grp_defined, cel_name, grp_count_dimensions, grp_dimensions, grp_order = nefis.inqngr(fp)
if not error == 0:
    error, err_string = nefis.neferr()
    print('    NEFIS error string       : "%s"' % err_string)
    print('    =========')
